...
public class AdsFragment extends Fragment implements Refrashable, SwipeRefreshLayout.OnRefreshListener {
    ...
    @SuppressLint("ValidFragment")
    public AdsFragment(DialogsActivity dialogsActivity){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       // adapter = new ChannelsAdapter(getContext(),R.layout.channel_item,new ArrayList<Channel>(),AdsFragment.this, dialogsActivity);
